...
tf.keras.utils.plot_model(my_model, "my_model.png", show_shapes=True, rankdir = "LR")
...
print(str(longitude) + " this is print\n")
print(str(latitude) + " this is print\n")
...
# Printing the concatenate and dense_output
print(str(concatenate_layer) + " this is print\n")
print(str(dense_output) + " this is print\n")
